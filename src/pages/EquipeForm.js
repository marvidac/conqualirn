...
export default class EquipeForm extends Component {
  ...
  componentDidMount() {
    if (this.props.route.params != undefined
      ...
      this.setState({
        ...
        selecionados: this.props.route.params.item.funcionarios,
        podeDeletar: true,
      })
    }
  ...
  buscarTodosItens() {
    FirebaseService.getDataList('funcionario', (dataRec) => {
      console.log(dataRec);
      this.setState({
        funcionarios: dataRec,
        isLoading: false
      })
    })
  }
  ...
  constroiObjetoParaSalvar() {
    ...
    paraSalvar.funcionarios = this.state.selecionados;
  ...
  render() {
    ...
    const labelMultiselect = `Selecione colaboradores para equipe`
